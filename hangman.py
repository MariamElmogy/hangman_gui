...
window = Tk()
chances=4
image_paths=['hang.png','img4.png','img3.png','img2.png','img1.png']
...
def clicked(alphabet):
    ...
    if alphabet in answer: #Its checks whether the albpbet is there in the answer
        ...
        chances = chances - 1
        if chances<0:
            messagebox.showinfo("It's Wrong..Try again","sorry ! you lose :'(")
            window.destroy()
    if btn01["text"]=="Z" and btn02["text"]=="O" and btn03["text"]=="M" and btn04["text"]=="B" and btn05["text"]=="I" and btn06["text"]=="E":
        messagebox.showinfo("hangman","Congrats You Won!!")
        window.destroy()
    print(chances)
